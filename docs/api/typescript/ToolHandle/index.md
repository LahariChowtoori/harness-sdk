Defined in: [src/agent/tool-caller.ts:40](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/agent/tool-caller.ts#L40)
...
Defined in: [src/agent/tool-caller.ts:48](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/agent/tool-caller.ts#L48)
...
Defined in: [src/agent/tool-caller.ts:57](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/agent/tool-caller.ts#L57)
