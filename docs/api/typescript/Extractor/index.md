Defined in: [src/memory/extraction/types.ts:74](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/memory/extraction/types.ts#L74)
...
Defined in: [src/memory/extraction/types.ts:82](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/memory/extraction/types.ts#L82)
