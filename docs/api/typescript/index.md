...
-   **Interfaces**
    ...
    -   [AgentMetadata](/docs/api/typescript/AgentMetadata/index.md)
    ...
    -   [ContextManagerConfig](/docs/api/typescript/ContextManagerConfig/index.md)
    -   [ContextState](/docs/api/typescript/ContextState/index.md)
    ...
    -   [OffloadConditions](/docs/api/typescript/OffloadConditions/index.md)
    ...
    -   [StashConfig](/docs/api/typescript/StashConfig/index.md)
    ...
    -   [SummarizeConfig](/docs/api/typescript/SummarizeConfig/index.md)
    ...
    -   [TruncateConfig](/docs/api/typescript/TruncateConfig/index.md)
...
-   **Type Aliases**
    ...
    -   [ContextManagerStrategy](/docs/api/typescript/ContextManagerStrategy/index.md)
    ...
    -   [OffloadTarget](/docs/api/typescript/OffloadTarget/index.md)
    ...
    -   [StrategyPresetName](/docs/api/typescript/StrategyPresetName/index.md)
