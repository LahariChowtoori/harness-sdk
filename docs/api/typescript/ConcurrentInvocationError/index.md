Defined in: [src/errors.ts:103](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/errors.ts#L103)
...
Defined in: [src/errors.ts:109](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/errors.ts#L109)
