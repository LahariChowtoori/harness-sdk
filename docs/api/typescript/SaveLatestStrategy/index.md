...
Defined in: [src/session/session-manager.ts:50](https://github.com/strands-agents/harness-sdk/blob/3bbfb60ae79b3941305737c1c5ca1e7ef639361f/strands-ts/src/session/session-manager.ts#L50)
