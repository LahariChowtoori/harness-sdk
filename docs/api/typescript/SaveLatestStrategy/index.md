...
Defined in: [src/session/session-manager.ts:50](https://github.com/strands-agents/harness-sdk/blob/d1e1d0acbb3718d71741eceedee029cda695dcfd/strands-ts/src/session/session-manager.ts#L50)
