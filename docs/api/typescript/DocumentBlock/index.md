Defined in: [src/types/media.ts:527](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L527)
...
Defined in: [src/types/media.ts:558](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L558)
...
Defined in: [src/types/media.ts:531](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L531)
...
Defined in: [src/types/media.ts:536](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L536)
...
Defined in: [src/types/media.ts:541](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L541)
...
Defined in: [src/types/media.ts:546](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L546)
...
Defined in: [src/types/media.ts:551](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L551)
...
Defined in: [src/types/media.ts:556](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L556)
...
Defined in: [src/types/media.ts:603](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L603)
...
| --- | --- | --- | --- |
| `document` | { `name`: `string`; `format`: [`DocumentFormat`](/docs/api/typescript/DocumentFormat/index.md); `source`: | { `bytes`: `string`; } | { `text`: `string`; } | { `content`: { `text`: `string`; }\[\]; } | { `location`: { `type`: `"s3"`; `uri`: `string`; `bucketOwner?`: `string`; }; }; `citations?`: { `enabled`: `boolean`; }; `context?`: `string`; } | \- | [src/types/media.ts:603](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L603) |
| `document.name` | `string` | Document name. | [src/types/media.ts:501](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L501) |
| `document.format` | [`DocumentFormat`](/docs/api/typescript/DocumentFormat/index.md) | Document format. | [src/types/media.ts:506](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L506) |
| `document.source` | | { `bytes`: `string`; } | { `text`: `string`; } | { `content`: { `text`: `string`; }\[\]; } | { `location`: { `type`: `"s3"`; `uri`: `string`; `bucketOwner?`: `string`; }; } | Document source. | [src/types/media.ts:511](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L511) |
| `document.citations?` | { `enabled`: `boolean`; } | Citation configuration. | [src/types/media.ts:516](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L516) |
| `document.citations.enabled` | `boolean` | \- | [src/types/media.ts:516](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L516) |
| `document.context?` | `string` | Context information for the document. | [src/types/media.ts:521](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L521) |
...
Defined in: [src/types/media.ts:632](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/types/media.ts#L632)
